      ...
      <div class="flex flex-col md:flex-row">
          ...
          <div class="flex-1 p-4">
              ...
              <div class="bg-white h-full p-8 rounded-xl shadow-lg animate-fadeIn">
                  ...
                  <p class="text-gray-700 mb-6">UMA Staffing If you are a CNA, PST, EGK, MAP, PST, PCT, PT, OT, RT,
                    LPN, RN or ARNP looking to work as needed at different facilities please click button to
                    apply.</p>
