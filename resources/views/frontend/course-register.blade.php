                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div>
                        <div class="pb-5 pt-lg-5 text-lg-start text-center">
                          ...
                          <div class="flex justify-center">
                            <div>
                              <input type="date" class="form-control" name="date" id="calendarPick" value=""
                    ...
                    <div>
                        <div class=" pb-5 pt-lg-5 text-lg-start text-center">
                            ...
                            <div class="mt-md-5 availability">
                ...
                onChange: function(selectedDates, dateStr, instance) {
                    ...
                    axios.get('{{ route('course.get-dates') }}', {
                        ...
                        .then(function(res) {
                            ...
                            if (res.data.event) {
                                const time = res.data.event.time;
                                let slots = parseInt('{{ $course->slot }}')
                                let bookedSlots = parseInt(res.data.slots)
                                let btnStatus = '';
                                @if ($course->type == 0 || $course->type == 3)
                              ...
                              `);
                                  ...
                                  <p>${course_name}</p>
                                  <p>{{ $course->address }}</p>
                                  <p>${course_zip_code} ${course_city} ${course_state}</p>
                                  ...
                                  <br>
                                  <a href="{{ route('course.checkout') }}?cid=${course_id}&course=${course_name}&date=${dateStr}" class="btn btn-primary w-75" style="border-radius:0px;">Next</a>
                              `);
                                @else
                                    let msg = ''
