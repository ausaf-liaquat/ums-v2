        ...
        $(document).ready(function() {
            let table = $("#dataTableSize").DataTable({
                language: {
                    ...
                    info: "Showing Frontend Contents _START_ to _END_ of _TOTAL_",
                    lengthMenu: 'Display <select class=\'form-select form-select-sm ms-1 me-1\'><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option><option value="-1">All</option></select> Frontend Contents'
                },

                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('frontend-contents.dataTable') }}',
                },
                columns: [{
                        "data": "DT_RowIndex",
                        "orderable": false,
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row, meta) {
                            ...
                            var edit = '{{ route('backend.frontend-contents.edit', [':course']) }}';
                ...
                drawCallback: function() {
                    ...
                    $(".js-status-switch").on("change", function() {
                        let url = "{{ route('backend.frontend-contents.status') }}";
                    ...
                    $(".js-delete-item").on("click", function() {
                        ...
                        Swal.fire({
                            ...
                            preConfirm: function(n) {
                                return axios
                                    .post(
                                        '{{ route('backend.frontend-contents.destroy') }}', {
                                            _method: 'delete',
                                            _token: '{{ csrf_token() }}',
                                            id: id,
                                        })
                                    .then(function(response) {
                                        ...
                                        Swal.fire(
                                            'Deleted!',
                                            'Frontend Contents has been deleted.',
                                            'success'
                                        )
                                        table.draw(false);
                                    })
