    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ route('backend.clinician-types.create') }}" class="btn btn-primary float-end">Add <i
        ...
        $(document).ready(function() {
            let table = $("#dataTableColor").DataTable({
                language: {
                    ...
                    info: "Showing Clinician types _START_ to _END_ of _TOTAL_",
                    lengthMenu: 'Display <select class=\'form-select form-select-sm ms-1 me-1\'><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option><option value="-1">All</option></select> Clinician types'
                },

                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('clinician-types.dataTable') }}',
                    data: {
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row, meta) {
                            ...
                            var edit = '{{ route('backend.clinician-types.edit', [':color']) }}';
                ...
                drawCallback: function() {
                    ...
                    $(".js-status-switch").on("change", function() {
                        let url = "{{ route('backend.clinician-types.status') }}";
                    ...
                    $(".js-delete-item").on("click", function() {
                        ...
                        Swal.fire({
                            ...
                            preConfirm: function(n) {
                                return axios
                                    .post(
                                        '{{ route('backend.clinician-types.destroy') }}', {
                                            _method: 'delete',
                                            _token: '{{ csrf_token() }}',
                                            id: id,
                                        })
                                    .then(function(response) {
                                        ...
                                        Swal.fire(
                                            'Deleted!',
                                            'Clinician type has been deleted.',
                                            'success'
                                        )
                                        table.draw(false);
                                    })
