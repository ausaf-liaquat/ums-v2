    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ route('backend.sizes.create') }}" class="btn btn-primary float-end">Add <i
        ...
        $(document).ready(function() {
            let table = $("#dataTableSize").DataTable({
                language: {
                    ...
                    lengthMenu: 'Display <select class=\'form-select form-select-sm ms-1 me-1\'><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option><option value="-1">All</option></select> sizes'
                },

                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('sizes.dataTable') }}',
                    data: {
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row, meta) {
                            ...
                            var edit = '{{ route('backend.sizes.edit', [':color']) }}';
                ...
                drawCallback: function() {
                    ...
                    $(".js-status-switch").on("change", function() {
                        let url = "{{ route('backend.sizes.status') }}";
