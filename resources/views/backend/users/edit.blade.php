    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <x-backend.layouts.edit :data="$user">
            <x-backend.section-header>
                ...
                {{-- <small class="text-muted">{{ __($module_title) }}
                    {{ __($module_action) }}
                </small> --}}
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        {{-- <div class="col-md-5 mb-3">
                            <img class="user-profile-image img-fluid img-thumbnail" src="{{ asset($user->avatar) }}"
                        ...
                        <div class="col-12 col-sm-10">
                            <div class="form-group">
                                <a class="btn btn-outline-primary btn-sm"
                                    href="{{ route('backend.users.changePassword', $user->id) }}"><i
                                        class="fas fa-key"></i>
                                    Change password</a>
                            </div>
                        </div>
                                ...
                                <div class="float-end">
                                    ...
                                    @if ($$module_name_singular->status == 2)
                                        <a class="btn btn-info" data-method="PATCH" data-token="{{ csrf_token() }}"
                                            ...
                                            title="{{ __('labels.backend.unblock') }}"><i class="fas fa-check"></i>
                                            Unblock</a>
                                    @endif
                ...
                files: [
                    @if (isset($user))
                        @php
                            ...
                            if (Storage::disk('cms')->exists($$module_name_singular->avatar)) {
                                $profileImg = Storage::disk('cms')->url($$module_name_singular->avatar);
                            }
                        @endphp {
                            source: '{{ $profileImg }}',
                        },
